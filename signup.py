...
frame=Frame(width=350,height=390,bg='#fff')
...
conform_code=Entry(frame,width=25,fg='black',border=0,bg='white',font=('Ariel',11))
...
Button(frame,width=39,pady=7,text='sign up',bg='#57a178',fg='white',border=0,command=signup).place(x=35,y=280)
label=Label(frame,text="I have an account?",fg='black',bg='white',font=('Ariel',11))
